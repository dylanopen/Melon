...
public class CmdViewdistanceSet {
    public static int execute(CommandContext<CommandSourceStack> ctx) throws CommandSyntaxException {
        ...
        ViewDistance.set(world, distance);
        HashMap<String, String> placeholders = getPlaceholders(ctx, world, distance);
        sender.sendMessage(formatMessage(applyPlaceholders(MessagesConfig.confirmViewdistance, placeholders)));
