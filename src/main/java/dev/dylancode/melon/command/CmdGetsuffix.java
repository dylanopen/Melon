...
public class CmdGetsuffix {
    public static int execute(CommandContext<CommandSourceStack> ctx) throws CommandSyntaxException {
        ...
        for (Player player : players) {
            ...
            sender.sendMessage(formatMessage(applyPlaceholders(Objects.requireNonNull(MessagesConfig.queryGetsuffix), placeholders)));
        }
    ...
    private static @NotNull HashMap<String, String> getPlaceholders(CommandContext<CommandSourceStack> ctx, Player player) {
        ...
        placeholders.put("suffix", CustomNameStorage.getSuffix(player.getUniqueId()));
        return placeholders;
    }
}
