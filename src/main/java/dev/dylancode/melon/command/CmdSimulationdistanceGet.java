...
public class CmdSimulationdistanceGet {
    public static int execute(CommandContext<CommandSourceStack> ctx) throws CommandSyntaxException {
        ...
        sender.sendMessage(formatMessage(applyPlaceholders(MessagesConfig.querySimulationdistance, placeholders)));
    ...
    private static @NotNull HashMap<String, String> getPlaceholders(CommandContext<CommandSourceStack> ctx, World world) {
        ...
        placeholders.put("distance", String.valueOf(SimulationDistance.get(world)));
        return placeholders;
    }
}
